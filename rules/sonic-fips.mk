...
FIPS_GOLANG_VERSION = 1.15.15-1~deb11u1+fips
...
FIPS_SSH = fips/ssh_$(FIPS_SSH_VERSION)_$(CONFIGURED_ARCH).deb
FIPS_OPENSSH_SERVER = fips/openssh-server_$(FIPS_SSH_VERSION)_$(CONFIGURED_ARCH).deb
FIPS_OPENSSH_CLIENT = fips/openssh-client_$(FIPS_SSH_VERSION)_$(CONFIGURED_ARCH).deb
FIPS_SSH_ALL = $(FIPS_SSH) $(FIPS_OPENSSH_SERVER) $(FIPS_OPENSSH_CLIENT)
...
FIPS_GOLANG = fips/golang-$(FIPS_GOLANG_MAIN_VERSION)_$(FIPS_GOLANG_VERSION)_$(CONFIGURED_ARCH).deb
...
FIPS_PACKAGE_ALL = $(SYMCRYPT_OPENSSL) $(FIPS_SSH_ALL) $(FIPS_GOLANG_ALL) $(FIPS_PYTHON_ALL)

ifeq ($(INCLUDE_FIPS), y)
  FIPS_BASEIMAGE_INSTALLERS = $(SYMCRYPT_OPENSSL) $(FIPS_SSH) $(FIPS_OPENSSH_SERVER) $(FIPS_GOLANG_ALL)
